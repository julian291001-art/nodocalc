      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            ...
            <a href="/herramientas/fases"></a><HerramientaCard nombre="Relaciones de fase" desc="Diagrama de fases interactivo. Ingresa 2 parámetros y calcula todos los demás." tag="Suelos" />
